...
@Autonomous(name="G.O.A.T. Around Red")
public class RedBasedAuto extends LinearOpMode {
    private Robot robot;
    ...
    private final Location middleOfNowhere = new Location(920,0,-1340,87.59);
// (Carousel) X=

    private final Location levelOneDeposit = new Location(33, 0, -1376.84, 131);
// (1st level score) X=

    private final Location levelTwoDeposit = new Location(31, 0, -1375.44, 132);
// 2nd level score) X=
    private final Location levelThreeDeposit = new Location(45.55, 0, -1451.57, 131);
    //(3rd level score) X=b
    private final Location StorageUnit = new Location(920, 0, -650, 87.59);
...
private final Location Intermediate = new Location(-308.37, 0, -365, 350.17);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        drive.moveToPosition(StorageUnit,5,5,2,1000);
        ...
        drive.moveToPosition(StorageUnit, 5, 5, 2,2000);
    }
}